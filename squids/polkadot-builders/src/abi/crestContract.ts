...
import {ABI_JSON} from './crestContract.abi'
...
export const functions = {
    ...
    dnaMap: new Func<[_: ethers.BigNumber], {}, ethers.BigNumber>(
        abi, '0x6922a963'
    ),
    ...
    mintSpecific: new Func<[to: string, dna: ethers.BigNumber], {to: string, dna: ethers.BigNumber}, []>(
        abi, '0x0b6b7eab'
    ),
...
export class Contract extends ContractBase {
    ...
    dnaMap(arg0: ethers.BigNumber): Promise<ethers.BigNumber> {
